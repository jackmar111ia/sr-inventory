        ...
        <div class="col-md-12 col-sm-12">
            <div class="panel tab-border ">
                ...
                <div class="panel-body">
                    ...
                    <form method="POST" action="{{ route('client.payments.save') }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <?php  inputfield("","text","amount","form-control",'amount','','',"Ex: 30000",'','',"","'','','',$errors");   ?>
                        ...
                        <div class="form-group row">
                            <label for="Date of deed" class="col-md-4 col-form-label text-md-right">{{ __('Pay date') }}</label>
                                ...
                                <div class="input-group date form_date col-4 col-md-4" data-date="" data-date-format="yyyy-mm-dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                    <?php inputfield("","text","pay_date","form-control",'pay_date','','pay_date',"yyyy-mm-dd",'','',"required","'','',off");  //,"'',disabled,off"?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="row g-0" >
                                    ...
                                    <div class="col-6 col-md-6">  
                                    <?php   selectoption("",'month_name',"form-control select2",'','month_name',$months,'month','month',"Month",''); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <?php textareaBox("","note_user",'','','Please write if you have any additional message','','','','',''); ?>
