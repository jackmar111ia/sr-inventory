	                    ...
	                    <ul class="sidemenu page-header-fixed p-t-20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                            ...
                            <div class="user-panel">
                              ...
                              <div class="profile-usertitle">
                                  ...
                                  <div class="profile-usertitle-job"> Customer Acount <br>
                              ...
                              */ ?>
	                          ...
	                          @include('clients.includes.dynamicNav')
                            ...
                            <li class="nav-item">
                                <a href="{{ url('user/logout') }}" class="nav-link nav-toggle"> <i class="material-icons">widgets</i>
