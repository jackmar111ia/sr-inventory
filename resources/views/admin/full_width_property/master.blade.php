...
<head>
    ...
    <title>Admin -{{ config('app.name') }} | @yield('page-title')</title>
    <!-- google font -->
    <link href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" rel="stylesheet" type="text/css" />
	<!-- icons -->
    <link href="{{ asset('backends2') }}/assets/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backends2') }}/assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
	<!--bootstrap -->
	<link href="{{ asset('backends2') }}/assets/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
 
	<!-- Template Styles -->
    <link href="{{ asset('backends2') }}/assets/css/plugins.min.css" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backends2') }}/assets/css/style.css" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backends2') }}/assets/css/responsive.css" rel="stylesheet" type="text/css" />
    <link href="{{ asset('backends2') }}/assets/css/theme-color.css" rel="stylesheet" type="text/css" />
	<!-- favicon -->
    <link rel="shortcut icon" href="{{ asset('backends2') }}/assets/img/favicon.ico" /> 
</head>
<!-- END HEAD -->
...
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md page-full-width header-white dark-sidebar-color logo-dark">
	...
	/*<div class="page-wrapper">
		...
		<div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
               ...
               <!-- end mobile menu -->
                <!-- start header menu -->
				<?php // @include('admin.full_width_property.topmenu')  ?>
            </div>
        </div>
	                            ...
	                            <div class="user-panel">
	                                <div class="row">
                                            <div class="sidebar-userpic">
                                                <img src="{{ asset('backends2') }}/img/dp.jpg" class="img-responsive" alt=""> </div>
                                        </div>
	...
	*/ ?>
    ...
    <script src="{{ asset('backends2') }}/assets/plugins/popper/popper.min.js" ></script>
    <script src="{{ asset('backends2') }}/assets/plugins/jquery-blockui/jquery.blockui.min.js" ></script>
	<script src="{{ asset('backends2') }}/assets/plugins/jquery-slimscroll/jquery.slimscroll.min.js"></script>
    <!-- bootstrap -->
 
   
    <!-- Common js-->
	<script src="{{ asset('backends2') }}/assets/js/app.js" ></script>
    <script src="{{ asset('backends2') }}/assets/js/layout.js" ></script>
    <script src="{{ asset('backends2') }}/assets/js/theme-color.js" ></script>
    <!-- material -->
    <script src="{{ asset('backends2') }}/assets/plugins/material/material.min.js"></script>
    <!-- animation -->
    <script src="{{ asset('backends2') }}/assets/js/pages/ui/animations.js" ></script>
    <!-- morris chart -->
    <script src="{{ asset('backends2') }}/assets/plugins/morris/morris.min.js" ></script>
    <script src="{{ asset('backends2') }}/assets/plugins/morris/raphael-min.js" ></script>
    <script src="{{ asset('backends2') }}/assets/js/pages/chart/morris/morris_home_data.js" ></script>
     <!-- end js include path -->
</body>
</html>