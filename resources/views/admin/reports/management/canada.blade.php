...
@section('page-title')
    <?php txt("Canada List Management"); ?>
@endsection
                    ...
                    <table class="table table-bordered table-striped">
                        <thead class="text-center">
                            ...
                            <div class="btn-group">
                                ...
                                <input type="hidden" value="canada" name="type">
                            </div>
                            </th>
                            <th><?php txt("Image");?></th>
                            <th><?php txt("Title");?> 
                        ...
                        <tbody> <?php $i = 1;?>
                            @foreach($q as $q1)
                            <tr> 
                                <td>{{ $i }} <input  class="sent_ids" <?php if($q1->canada_view == "yes") echo "checked";?> name="id[]" type="checkbox"  value="<?php echo $q1->id; ?>"></td>
