...
<?php $GenInfoStatus =  GenInfoAlert(Auth::user()->id);  
            ...
            <div class="panel-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="PasswordChange">
                        @include('moderator.settings.includes.changePassword')
                    </div>

                    <div class="tab-pane" id="AccountsInfo">
                    @include('moderator.settings.includes.accountsInfo') 
                        <?php clear();?>
                    </div>
                    ...
                    <div class="tab-pane" id="updateViewGeneralInfo">
                        ...
                        @if($GenInfoStatus == "saved")
                            @include('moderator.settings.includes.genInfoDraftView')
                        @endif

                        @if($GenInfoStatus == "locked")
                            @include('moderator.settings.includes.genInfoSentView')
                         @endif
