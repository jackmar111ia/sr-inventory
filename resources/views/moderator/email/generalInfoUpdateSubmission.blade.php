...
<body style="background:#f5f5f5;padding:0px ">
    ...
    <div style="background:#fff; padding:10px; border:dotted 1px green; ">
        ...
        Update request from moderator
        </h3>
        <p> <b>Dear Admin,</b></p>
        <p>
           
           Moderator {{ $name }} has submitted the info for update.  <br>
           Please review the update for approval.<br>
           Please login the panel and see in moderator mangement section!
         </p>
